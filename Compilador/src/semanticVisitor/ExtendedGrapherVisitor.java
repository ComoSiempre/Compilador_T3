...
public class ExtendedGrapherVisitor implements visitor {
     ...
     */
    public ExtendedGrapherVisitor(String pathBase, int numEjercicio){
    ...
    public void visitar(Expression expresion) {
        String ident= expresion.toExtendedGrapher(this.cantNodosVisitados);
        this.codigoGraph +=ident;
        String [] delimitador = ident.split("\\[");
        String enlace = this.auxPadres.peek()+"->"+delimitador[0]+"; \n";
        this.codigoGraph += enlace;
    ...
    public void visitar(Var var) {
        ...
        if(var.getExpression()==null){
            ...
            if(var.getID()==null){
                ...
                ident=var.toExtendedGrapher(cantNodosVisitados);
            }
            this.codigoGraph += ident;
            String [] delimitador=ident.split("\\[");
            String enlace=this.auxPadres.peek()+"->"+delimitador[0]+"; \n";
            ...
            if(var.getID()==null){
                ...
                ident = var.toExtendedGrapher(this.cantNodosVisitados);
            }
